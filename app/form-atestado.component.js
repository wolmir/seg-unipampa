...
// 	const dateAction$        = iToA('.date-input')('DATE_INPUT');
// 	const advisorAction$     = iToA('.advisor-input')('ADVISOR_INPUT');
// 	const projectAction$     = iToA('.project-input')('PROJECT_INPUT');
// 	const locationAction$    = iToA('.location-input')('LOCATION_INPUT');
// 	const descriptionAction$ = iToA('.description-input')('DESCRIPTION_INPUT');
